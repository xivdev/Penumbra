...
public static class Colors
{
    ...
    public static (uint DefaultColor, string Name, string Description) Data(this ColorId color)
        => color switch
        {
            ...
            ColorId.GroupSeparatorExpanded        => ( 0x80806E6E, "Option Group Separator and Border (Expanded)",  "The color for the line separator for option groups and the frame borders for them, when the group is expanded."),
