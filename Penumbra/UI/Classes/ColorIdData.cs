...
public struct ColorIdData : IColorData<ColorId>
{
    ...
    private static readonly StringU8 ModSelector  = new("Mod Selector"u8);
    private static readonly StringU8 Metadata     = new("Metadata"u8);
    private static readonly StringU8 Collections  = new("Collections"u8);
    private static readonly StringU8 ResourceTree = new("Resource Tree"u8);
    private static readonly StringU8 ModSettings  = new("Mod Settings"u8);
