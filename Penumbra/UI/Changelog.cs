...
public class PenumbraChangelog : IUiService
{
    ...
    private static void Add1_7_1_0(Changelog log)
        => log.NextVersion("Version 1.7.1.0"u8)
            ...
            .RegisterHighlight("Significantly updated the material editor (thanks Ny!)."u8)
            .RegisterEntry("Renamed previously unknown fields to Exposure, Anisotropy, and Scroll Parameters."u8, 1)
            .RegisterEntry("Streamlined the layout of the color table and added support for narrow windows"u8, 1)
            ...
            .RegisterEntry("Added a viewer for SPM files (thanks Ny!)."u8)
